...
class LexicalAnalyzer:
    ...
    def function_calling(self):
        ...
        self.generate_quadruple(operation=int(OperationCodes.GOSUB), left_operand=int(OperationCodes.NONE), right_operand=int(OperationCodes.NONE), result=ip)
        ...
        if address_function != None and type_function != DataType.VOID:
